...
const Footer = (): JSX.Element => {
  ...
  return (
    <Stack className='w-full'>
      <Stack
        className='w-full bg-blue-700 text-white py-2 text-md md:text-lg'
        alignItems={'center'}
        direction={'column'}>
      ...
      <Stack
        ...
        <Box className='flex-1'>
          <FooterItem
            ...
            content={
              <>
                <p className='text-md text-gray-500'>Trang thương mại chính thức của Vite Shop.</p>
        ...
        <Box className='flex-1'>
          <FooterItem
            ...
            content={
              <>
                <ul className='pl-4 space-y-2 text-md text-gray-500'>
                  <li>
      ...
      <Box className='px-2'>
        <p className='text-sm text-center leading-4 text-gray-500'>
          Copyright © 2024 Bản quyền của Công ty cổ phẩn Mocato Việt Nam
        </p>
      </Box>
    </Stack>
  );
